                    ...
                    <div class="item-menu">
                        ...
                        <div class="children">
                            <ul class="pro-list">
                                <li
                                    class="product"
                                    v-for="item in product.phoneList"
                                    :key="item.id"
                                >
                                    <a
                    ...
                    <div class="item-menu">
                        ...
                        <div class="children">
                            <ul class="pro-list">
                                <li
                                    class="product"
                                    v-for="item in product.redMiList"
                                    :key="item.id"
                                >
                                    <a
                                        :href="'/#/product/' + item.id"
    ...
    methods: {
        async getProductList() {
            ...
            if (res.list.length > 6) {
                this.product.phoneList = res.list.slice(4, 10)
                this.product.redMiList = res.list.slice(11, 17)
            }
        },
        goToCart() {
